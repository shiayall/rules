function main(config) {
  ...
  config["proxy-groups"] = [
    ...
    { name: "电报消息", type: "select", proxies: fullProxies },
    { name: "FCM 推送", type: "select", proxies: fullProxies },
  ...
  config["rule-providers"] = {
    ...
    "bahamut": { type: "http", behavior: "domain", format: "mrs", interval: 604800, path: "./ruleset/bahamut.mrs", url: GH + "/geosite/bahamut.mrs" },
